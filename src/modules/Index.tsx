    ...
    return (
        <html>
            <head>
                ...
                <script dangerouslySetInnerHTML={ { __html: `window.__STATE__ = ${JSON.stringify(loadState)}`} }></script>
            </head>
            <body style={ {background: appParams.theme === THEME.light ? THEME_COLOR.light : THEME_COLOR.dark} }>
