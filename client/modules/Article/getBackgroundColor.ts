...
export const getBackgroundColor: (id: string) => string = (id: string) => {
  ...
  const firstColor = `rgba(${firstThreeChar.charCodeAt(2)}, ${firstThreeChar.charCodeAt(1)},${firstThreeChar.charCodeAt(0)})`;
  const secondColor = `rgba(${secondThreeChar.charCodeAt(2)}, ${secondThreeChar.charCodeAt(1)}, ${secondThreeChar.charCodeAt(0)})`;
